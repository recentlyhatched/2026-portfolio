...
Open [http://localhost:5713](http://localhost:5713) to view it in the browser. For ChromeOS, follow the *last* network link (with your Crostini IP). It should looks somethin like Network: http://100.xxx.xx.xxx/5713
